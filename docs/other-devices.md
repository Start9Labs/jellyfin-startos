...
First you need to install and trust a StartOS root CA certificate on your Apple TV for secure local HTTPS connections (If you have not pointed a public domain name to your Jellyfin service).
